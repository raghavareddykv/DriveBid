...
[assembly: SuppressMessage(
    ...
    Scope = "member",
    Target = "~P:IdentityService.TestUsers.Users"
)]
[assembly: SuppressMessage(
    "Design",
    ...
    Scope = "type",
    Target = "~T:IdentityService.Pages.Login.ViewModel.ExternalProvider"
)]
[assembly: SuppressMessage(
    "Naming",
    ...
    Scope = "namespace",
    Target = "~N:IdentityService.Pages.Error"
)]
[assembly: SuppressMessage(
    "Naming",
    ...
    Scope = "type",
    Target = "~T:IdentityService.Pages.Ciba.Consent"
)]
[assembly: SuppressMessage(
    "Naming",
    "CA1724:Type names should not match namespaces",
    Justification = "Namespaces of pages are not likely to be used elsewhere, so there is little chance of confusion",
    Scope = "type",
    Target = "~T:IdentityService.Pages.Extensions"
)]
[assembly: SuppressMessage(
    "Performance",
    ...
    Scope = "member",
    Target = "~F:IdentityService.Pages.Logout.LogoutOptions.AutomaticRedirectAfterSignOut"
)]
